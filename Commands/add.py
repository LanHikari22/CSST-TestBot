...
class AddCMD(BotCMD):
    ...
    def isValid(self, command, argv=None):
        ...
        if argv:
            if len(argv) < 2: return self.MISSING_ARGS
    ...
    def get_error_msg(self, error_code: int):
        ...
        if error_code == self.MISSING_ARGS:
            ...
            error_msg = "I don't think %s is a number..." % self.argv[1]
        elif error_code == self.ARG2_FAILURE:
            error_msg = "I don't think %s is a number..." % self.argv[2]
